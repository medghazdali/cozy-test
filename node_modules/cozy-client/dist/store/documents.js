...
var storeDocument = function storeDocument(state, document) {
  ...
  if ((0, _isEqual.default)(existingDoc, document)) {
    ...
    return (0, _objectSpread5.default)({}, state, (0, _defineProperty2.default)({}, type, (0, _objectSpread5.default)({}, state[type], (0, _defineProperty2.default)({}, (0, _helpers.properId)(document), mergeDocumentsWithRelationships(existingDoc, document)))));
  }
};
...
var mergeDocumentsWithRelationships = function mergeDocumentsWithRelationships() {
  ...
  var merged = (0, _objectSpread5.default)({}, prevDocument, nextDocument);
  if (prevDocument.relationships || nextDocument.relationships) merged.relationships = (0, _objectSpread5.default)({}, prevDocument.relationships, nextDocument.relationships);
  return merged;
}; // reducer
...
var documents = function documents() {
  ...
  if (action && action.definition && action.definition.mutationType === _dsl.MutationTypes.DELETE_DOCUMENT) {
    ...
    return (0, _objectSpread5.default)({}, state, (0, _defineProperty2.default)({}, _type, (0, _omit.default)(state[_type], docId)));
  }
...
var extractAndMergeDocument = function extractAndMergeDocument(data, updatedStateWithIncluded) {
  ...
  if (updatedStateWithIncluded && updatedStateWithIncluded[doctype]) {
    Object.values(updatedStateWithIncluded[doctype]).map(function (dataState) {
      ...
      if (sortedData[id]) {
        mergedData[doctype][id] = (0, _objectSpread5.default)({}, dataState, sortedData[id], mergedData[doctype][id]);
      } else {
        mergedData[doctype][id] = (0, _objectSpread5.default)({}, dataState, mergedData[doctype][id]);
      }
    });
  }
  ...
  Object.values(sortedData).map(function (data) {
    ...
    if (mergedData[doctype][id]) {
      mergedData[doctype][id] = (0, _objectSpread5.default)({}, mergedData[doctype][id], data);
    } else {
      mergedData[doctype][id] = data;
    }
  });
  return (0, _objectSpread5.default)({}, updatedStateWithIncluded, mergedData);
};
