...
var AdministrativeProcedure = require('./AdministrativeProcedure');
...
describe('AdministrativeProcedure model', function () {
  describe('getPersonalData', function () {
    it('should return the personal data for the given contact', function () {
      var dany = {
        fullname: '',
        name: {
          givenName: 'Daenerys',
      ...
      var fields = ['lastname', 'firstname', 'salary', 'address', 'phone', 'email', 'maritalStatus', 'numberOfDependants', 'additionalIncome'];
      var expected = {
        lastname: 'Targaryen',
        firstname: 'Daenerys',
      ...
      var result = AdministrativeProcedure.getPersonalData(dany, fields);
      expect(result).toEqual(expected);
    });
  });
  describe('create', function () {
    it('should return an io.cozy.procedures.administratives object', function () {
      var data = {
        procedureData: {
          amount: 5000,
          duration: 36
      ...
      var result = AdministrativeProcedure.create(data, template);
  ...
  describe('createJson', function () {
    it('should return the json for this procedure', function () {
      var procedure = {
        procedureData: {
          amount: 5000,
          duration: 36
      ...
      var result = AdministrativeProcedure.createJson(procedure); // turn the json back to an object for snapshot readability
